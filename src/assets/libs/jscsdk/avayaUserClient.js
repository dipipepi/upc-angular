...
(function(AvayaUserClient) {
    ...
    function VirtualRoomSetup(virtualRoomSetup) {
        ...
        if (typeof virtualRoomSetup !== 'undefined' && virtualRoomSetup !== null) {
            ...
            this._terminateMeetingWhenModeratorLeft = virtualRoomSetup.terminateMeetingWhenModeratorLeft || false;
            ...
            this._terminateMeetingWhenModeratorLeft = false;
            this._attendees = [];
     ...
     * @memberOf AvayaUserClient.UserService.UserDetails.Conferencing.VirtualRoomSetup
     */
    Object.defineProperty(VirtualRoomSetup.prototype, 'terminateMeetingWhenModeratorLeft', {
        get : function () {
            return this._terminateMeetingWhenModeratorLeft;
        },
        set : function (val) {
            this._terminateMeetingWhenModeratorLeft = val;
        }
    });
